An alternative **PayPal** module for **Magento 2** you can get fast support and customizations for.

## How to buy
The extension is not released yet, so there is no way to buy it just now.  
The extension will be released before 2017-05-18.   
...
### 2. Self-installation
```
composer require mage2pro/paypal:*
...
## Support
- [The extension's **forum** branch](https://mage2.pro/c/extensions/paypal).
...
- [Subscribe](https://mage2.pro/t/2540) to the extension's [forum branch](https://mage2.pro/c/extensions/paypal).
...
- «[**Paypal**](https://mage2.pro/c/extensions/paypal)» payment extension (Philippines).
